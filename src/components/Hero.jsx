...
export default function Hero() {
	return (
		<section className="text-gray-400 bg-gray-900 body-font w-full min-h-screen bg-fixed bg-cover bg-no-repeat bg-center bg-opacity-10 bg-gradient-to-r from-slate-900 to-slate-500">
			<div className=" min-w-full min-h-screen  absolute opacity-100 flex px-24 lg:px-0 flex-col lg:flex-row items-center overflow-hidden">
				...
				<div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-18 py-3 flex flex-col md:items-start md:text-left items-center text-center overflow-hidden">
