...
export default function TableKit({ QueryOpt }) {
	...
	return (
		<table className='w-[840px] my-3 px-3'>
			...
			<tbody>
				{/* <!-- DVR --> */}
				<tr className='grid grid-flow-col gap-1 grid-cols-7 text-sm text-center bg-slate-700  px-3'>
					<td>HKI-7208-HQHI</td>
					<td>HikVision</td>
					<td>XVR 8CH 2MP</td>
					<td>1</td>
				...
				{/* <!-- CAMARAS --> */}
				<tr className='grid grid-flow-col gap-1 grid-cols-7 text-sm text-center bg-slate-600  px-3'>
					<td>{CAM.model}</td>
					<td>{CAM.trademark}</td>
