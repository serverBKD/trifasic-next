export default function Pricing() {
	return (
		<section className="text-gray-400 bg-slate-900 body-font overflow-hidden">
				...
				<div className="flex flex-wrap -m-4">
					<div className="p-4 xl:w-1/4 md:w-1/2 w-full">
						<div className="h-full p-6 rounded-lg border-2 border-gray-700 flex flex-col relative overflow-hidden">
							...
							<p className="text-xs text-gray-400 mt-3">Literally you probably heard of them jean shorts.</p>
						</div>
					</div>
					<div className="p-4 xl:w-1/4 md:w-1/2 w-full">
